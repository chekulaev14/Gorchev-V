...
Item.weight — убрано. Ранее было информационное поле (вес заготовки), в логике не участвовало. Вес сырья учитывается через quantity в единицах измерения (кг).
...
ErrorBoundary в components/ui/. Интеграция: app/warehouse/layout.tsx, app/terminal/layout.tsx. Бизнес-ошибки — через toast.
